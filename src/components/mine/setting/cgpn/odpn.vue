    ...
    <div class="addcard-content">
      ...
      <div class="list">
        <div class="item">
          ...
          <button @click="clickedFun(60)" :disabled="clicked" class="odpn" :class="{ 'clicked': clicked}"> <span v-if="!clicked" style="width: 1.4rem;color: #33a1ff">发送验证码</span> <span v-if="clicked">{{sendMseDisabled}}s</span> </button>
        </div>
      </div>
